        ...
        <form action={formAction as any} className="w-full max-w-md mx-auto space-y-10">
          ...
          <div className="space-y-4">
             ...
             <label className="flex items-center gap-3 text-xs font-bold tracking-widest uppercase text-[#121212]/60">
                {t.rich('nameLabel', { num: (chunks) => <span className="text-[#121212]">{chunks}</span> })}
             </label>
             <input
               type="text"
               name="name"
          ...
          <div className="space-y-4">
             <label className="flex items-center gap-3 text-xs font-bold tracking-widest uppercase text-[#121212]/60">
                {t.rich('urlLabel', { num: (chunks) => <span className="text-[#121212]">{chunks}</span> })}
             </label>
             <div className="relative">
               <Globe className="absolute start-0 top-1/2 -translate-y-1/2 text-[#121212]/20 h-6 w-6 md:h-8 md:w-8" />
               <input
                 type="url"
                 name="url"
                 required
                 className="w-full bg-transparent border-b-2 border-[#121212]/20 py-4 ps-10 md:ps-12 text-2xl md:text-3xl text-[#121212] placeholder-[#121212]/20 focus:outline-none focus:border-[#C04C36] transition-colors rounded-none"
