      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          <div className="flex justify-between items-start mb-4">
            <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest">{t('businessSummary')}</h3>
            <button 
              type="button" 
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          <div className="flex justify-between items-start mb-4">
            <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest">{t('targetAudience')}</h3>
            <button 
              type="button" 
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          <div className="flex justify-between items-start mb-4">
            <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest">{t('brandTone')}</h3>
            <button 
              type="button" 
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          <div className="flex justify-between items-start mb-4">
            <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest">{t('detectedIndustry')}</h3>
            <button 
              type="button" 
        ...
        {summary.positioningOpportunity && (
          <div className="bg-white rounded-2xl border border-indigo-100 p-6 shadow-sm shadow-indigo-100 sm:col-span-2">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-sm font-bold text-indigo-500 flex items-center gap-1.5 uppercase tracking-widest"><Sparkles className="w-4 h-4"/> {t('positioning')}</h3>
            </div>
        ...
        {summary.messagingDifferentiation && (
          <div className="bg-white rounded-2xl border border-emerald-100 p-6 shadow-sm shadow-emerald-100 sm:col-span-2">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-sm font-bold text-emerald-600 flex items-center gap-1.5 uppercase tracking-widest"><Sparkles className="w-4 h-4"/> {t('messaging')}</h3>
            </div>
            <p className="text-[#121212] text-sm leading-relaxed">
              {summary.messagingDifferentiation}
            </p>
