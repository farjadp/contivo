        ...
        <Panel title="Workspace Profile" subtitle="Owner, URL, lifecycle state, and timestamps">
          <KeyValueGrid
            items={[
              ...
              { label: 'Owner', value: <Link href={{ pathname: '/admin/users/[userId]', params: { userId: workspace.user.id } }} className="font-semibold text-slate-700 hover:underline">{workspace.user.email}</Link> },
